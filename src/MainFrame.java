...
public class MainFrame extends JFrame{
	...
	public MainFrame(Secretariat aSecreatariat) {
		frame = new JFrame();
		this.sec=aSecreatariat;
		...
		frame.setTitle("Bus Management System");
	...
	class ButtonListener implements ActionListener {
		public void actionPerformed(ActionEvent e) { 
			...
			if(e.getSource() == PassengerButton) {
				...
				PassengerLoginFrame passengerLoginFrame= new PassengerLoginFrame(sec,frame);
				frame.dispose();
			
			}
			else if(e.getSource() == DriverButton) {
				DriverLoginFrame driverFrame = new DriverLoginFrame(sec,driver,frame);
				frame.dispose();
			}
			else if(e.getSource() == SecretaryButton) {
				
			SecretaryLoginFrame SecretaryLoginFrame= new SecretaryLoginFrame(frame,sec);
				frame.dispose();
