...
public class Main {
	...
	public static void main(String[] args) {
		...
		//Initiate bus lines.
		ArrayList<BusLine> BusLines = new ArrayList<BusLine>(BusLine.initiateBusLines());
		
		//Initiate bus routes.
		ArrayList<BusRoute> BusRoutes = new ArrayList<BusRoute>(BusRoute.initiateBusRoutes());
